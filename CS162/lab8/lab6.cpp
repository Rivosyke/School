...
/*********************************************************************
** Description: This struct has two pointers: forward and back to
...
/*********************************************************************
** Description: This class implements a doubly linked list and all 
** the methods it will need to do the functions required in main.
*********************************************************************/
class SimpleList
{
	private:
